...
//    @Mock private DataContext dataContext;
    ...
    private List<TaskLinkEntity> linkEntities = new ArrayList<>();
    ...
    public void setUp() {
        ...
        // TaskLinkEntity instances
        TaskLinkEntity linkEntityP = TaskLinkEntity.builder()
                .id(20L)
                .child(taskEntity)
                .parent(parent)
                .build();
        TaskLinkEntity linkEntity1 = TaskLinkEntity.builder()
                .id(21L)
                .child(child1)
                .parent(taskEntity)
                .build();
        TaskLinkEntity linkEntity2 = TaskLinkEntity.builder()
                .id(22L)
                .child(child2)
                .parent(taskEntity)
                .build();
        TaskLinkEntity linkEntity3 = TaskLinkEntity.builder()
                .id(23L)
                .child(child3)
                .parent(taskEntity)
                .build();
        ...
        List<TaskLinkEntity> childLinkEntities = List.of(linkEntity1, linkEntity2, linkEntity3);
...
//        when(dataContext.updateTask(taskEntity)).thenReturn(taskEntity);
        ...
        TaskEntity result = entityMapper.toEntity(task);
...
//        when(dataContext.updateTask(expectedUpdatedTaskEntity)).thenReturn(expectedUpdatedTaskEntity);
        ...
        TaskEntity result = entityMapper.toEntity(updatedTask);
