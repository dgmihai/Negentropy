 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Zt,eo,to,oo;const j=window,v=o=>{j.emitLitDebugLogEvents&&j.dispatchEvent(new CustomEvent("lit-debug",{detail:o}))};let An=0,kt;(Zt=j.litIssuedWarnings)!==null&&Zt!==void 0||(j.litIssuedWarnings=new Set),kt=(o,e)=>{e+=o?` See https://lit.dev/msg/${o} for more information.`:"",j.litIssuedWarnings.has(e)||(console.warn(e),j.litIssuedWarnings.add(e))},kt("dev-mode","Lit is in dev mode. Not recommended for production!");const H=!((eo=j.ShadyDOM)===null||eo===void 0)&&eo.inUse&&((to=j.ShadyDOM)===null||to===void 0?void 0:to.noPatch)===!0?j.ShadyDOM.wrap:o=>o,Oe=j.trustedTypes,Sr=Oe?Oe.createPolicy("lit-html",{createHTML:o=>o}):void 0,In=o=>o,Mt=(o,e,t)=>In,Rn=o=>{if(we!==Mt)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");we=o},On=()=>{we=Mt},ko=(o,e,t)=>we(o,e,t),$o="$lit$",re=`lit$${String(Math.random()).slice(9)}$`,gi="?"+re,zn=`<${gi}>`,be=document,Ge=()=>be.createComment(""),Ke=o=>o===null||typeof o!="object"&&typeof o!="function",fi=Array.isArray,Ln=o=>fi(o)||typeof(o==null?void 0:o[Symbol.iterator])=="function",ro=`[ 	
\f\r]`,Mn=`[^ 	
\f\r"'\`<>=]`,Vn=`[^\\s"'>=/]`,je=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Er=1,io=2,Dn=3,Cr=/-->/g,kr=/>/g,ge=new RegExp(`>|${ro}(?:(${Vn}+)(${ro}*=${ro}*(?:${Mn}|("|')|))|$)`,"g"),jn=0,$r=1,Un=2,Tr=3,no=/'/g,so=/"/g,vi=/^(?:script|style|textarea|title)$/i,Fn=1,$t=2,Lo=1,Tt=2,Bn=3,Hn=4,qn=5,Mo=6,Wn=7,yi=o=>(e,...t)=>(e.some(r=>r===void 0)&&console.warn(`Some template strings are undefined.
...
`);async function Os(o){const e=new ce(o),t=document.createElement(o.tagName);t.classList.add(Or),document.body.append(t),o.setupElement&&await o.setupElement(t);const r={themeScope:D.local,localClassName:Or};try{o.elements.forEach(i=>{Mr(t,i,r,!0);let n=Le(i,r);const s=n.match(zr);n=n.replace(zr,"");const l=n.match(Lr),a=n.replace(Lr,"");let d=document.querySelector(a);if(d&&l){const h=`[part~="${l[1]}"]`;d=d.shadowRoot.querySelector(h)}if(!d)return;d.style.transition="none";const c=s?s[1]:null,m=getComputedStyle(d,c);i.properties.forEach(h=>{const g=m.getPropertyValue(h.propertyName)||h.defaultValue||"";e.updatePropertyValue(i.selector,h.propertyName,g)}),Mr(t,i,r,!1)})}finally{try{o.cleanupElement&&await o.cleanupElement(t)}finally{t.remove()}}return e}function Mr(o,e,t,r){if(e.stateAttribute){if(e.stateElementSelector){const i=Le({...e,selector:e.stateElementSelector},t);o=document.querySelector(i)}o&&(r?o.setAttribute(e.stateAttribute,""):o.removeAttribute(e.stateAttribute))}}function Vr(o){return o.trim()}function zs(o){const e=o.element;if(!e)return null;const t=e.querySelector("label");if(t&&t.textContent)return Vr(t.textContent);const r=e.textContent;return r?Vr(r):null}class Ls{constructor(){this._localClassNameMap=new Map}get stylesheet(){return this.ensureStylesheet(),this._stylesheet}add(e){this.ensureStylesheet(),this._stylesheet.replaceSync(e)}clear(){this.ensureStylesheet(),this._stylesheet.replaceSync("")}previewLocalClassName(e,t){if(!e)return;const r=this._localClassNameMap.get(e);r&&(e.classList.remove(r),e.overlayClass=null),t?(e.classList.add(t),e.overlayClass=t,this._localClassNameMap.set(e,t)):this._localClassNameMap.delete(e)}ensureStylesheet(){this._stylesheet||(this._stylesheet=new CSSStyleSheet,this._stylesheet.replaceSync(""),document.adoptedStyleSheets=[...document.adoptedStyleSheets,this._stylesheet])}}const fe=new Ls;class Ms{constructor(e){this.pendingRequests={},this.requestCounter=0,this.globalUiId=this.getGlobalUiId(),this.wrappedConnection=e;const t=this.wrappedConnection.onMessage;this.wrappedConnection.onMessage=r=>{r.command==="themeEditorResponse"?this.handleResponse(r.data):t.call(this.wrappedConnection,r)}}sendRequest(e,t){const r=(this.requestCounter++).toString(),i=t.uiId??this.globalUiId;return new Promise((n,s)=>{this.wrappedConnection.send(e,{...t,requestId:r,uiId:i}),this.pendingRequests[r]={resolve:n,reject:s}})}handleResponse(e){const t=this.pendingRequests[e.requestId];if(!t){console.warn("Received response for unknown request");return}delete this.pendingRequests[e.requestId],e.code==="ok"?t.resolve(e):t.reject(e)}loadComponentMetadata(e){return this.sendRequest("themeEditorComponentMetadata",{nodeId:e.nodeId})}setLocalClassName(e,t){return this.sendRequest("themeEditorLocalClassName",{nodeId:e.nodeId,className:t})}setCssRules(e){return this.sendRequest("themeEditorRules",{rules:e})}loadRules(e){return this.sendRequest("themeEditorLoadRules",{selectors:e})}markAsUsed(){return this.sendRequest("themeEditorMarkAsUsed",{})}undo(e){return this.sendRequest("themeEditorHistory",{undo:e})}redo(e){return this.sendRequest("themeEditorHistory",{redo:e})}openCss(e){return this.sendRequest("themeEditorOpenCss",{selector:e})}getGlobalUiId(){const e=window.Vaadin;if(e&&e.Flow){const{clients:t}=e.Flow,r=Object.keys(t);for(const i of r){const n=t[i];if(n.getNodeId)return n.getUIId()}}return-1}}const O={index:-1,entries:[]};class Vs{constructor(e){this.api=e}get allowUndo(){return O.index>=0}get allowRedo(){return O.index<O.entries.length-1}get allowedActions(){return{allowUndo:this.allowUndo,allowRedo:this.allowRedo}}push(e,t,r){const i={requestId:e,execute:t,rollback:r};if(O.index++,O.entries=O.entries.slice(0,O.index),O.entries.push(i),t)try{t()}catch(n){console.error("Execute history entry failed",n)}return this.allowedActions}async undo(){if(!this.allowUndo)return this.allowedActions;const e=O.entries[O.index];O.index--;try{await this.api.undo(e.requestId),e.rollback&&e.rollback()}catch(t){console.error("Undo failed",t)}return this.allowedActions}async redo(){if(!this.allowRedo)return this.allowedActions;O.index++;const e=O.entries[O.index];try{await this.api.redo(e.requestId),e.execute&&e.execute()}catch(t){console.error("Redo failed",t)}return this.allowedActions}static clear(){O.entries=[],O.index=-1}}var Ds=Object.defineProperty,js=Object.getOwnPropertyDescriptor,ue=(o,e,t,r)=>{for(var i=r>1?void 0:r?js(e,t):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(i=(r?s(e,t,i):s(i))||i);return r&&i&&Ds(e,t,i),i};class Us extends CustomEvent{constructor(e,t,r){super("theme-property-value-change",{bubbles:!0,composed:!0,detail:{element:e,property:t,value:r}})}}class q extends A{constructor(){super(...arguments),this.value=""}static get styles(){return[_i,b`
    ...
    </div>`}handleInputChange(o){this.editedClassName=o.detail.value;const e=/^-?[_a-zA-Z]+[_a-zA-Z0-9-]*$/;this.invalid=!this.editedClassName.match(e),!this.invalid&&this.editedClassName!==this.className&&this.dispatchEvent(new Hs(this.editedClassName))}};Dt([y({})],Qe.prototype,"className",2);Dt([T()],Qe.prototype,"editedClassName",2);Dt([T()],Qe.prototype,"invalid",2);Qe=Dt([F("vaadin-dev-tools-theme-class-name-editor")],Qe);var qs=Object.defineProperty,Ws=Object.getOwnPropertyDescriptor,jt=(o,e,t,r)=>{for(var i=r>1?void 0:r?Ws(e,t):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(i=(r?s(e,t,i):s(i))||i);return r&&i&&qs(e,t,i),i};class Gs extends CustomEvent{constructor(e){super("scope-change",{detail:{value:e}})}}jo(b`
...
`);let Ze=class extends A{constructor(){super(...arguments),this.value=D.local}static get styles(){return b`
    ...
    ></vaadin-select>`}selectRenderer(o){var e;const t=((e=this.metadata)==null?void 0:e.displayName)||"Component",r=`${t}s`;Ie(f`
      ...
      `,o)}handleValueChange(o){const e=o.detail.value;e!==this.value&&this.dispatchEvent(new Gs(e))}};jt([y({})],Ze.prototype,"value",2);jt([y({})],Ze.prototype,"metadata",2);jt([rt("vaadin-select")],Ze.prototype,"select",2);Ze=jt([F("vaadin-dev-tools-theme-scope-selector")],Ze);var Ks=Object.defineProperty,Ys=Object.getOwnPropertyDescriptor,Js=(o,e,t,r)=>{for(var i=r>1?void 0:r?Ys(e,t):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(i=(r?s(e,t,i):s(i))||i);return r&&i&&Ks(e,t,i),i};let jr=class extends q{static get styles(){return[q.styles,b`
        .editor-row {
          align-items: center;
        }
      `]}handleInputChange(o){const e=o.target.checked?this.propertyMetadata.checkedValue:"";this.dispatchChange(e||"")}renderEditor(){const o=this.value===this.propertyMetadata.checkedValue;return f` <input type="checkbox" .checked=${o} @change=${this.handleInputChange} /> `}};jr=Js([F("vaadin-dev-tools-theme-checkbox-property-editor")],jr);var Xs=Object.defineProperty,Qs=Object.getOwnPropertyDescriptor,Zs=(o,e,t,r)=>{for(var i=r>1?void 0:r?Qs(e,t):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(i=(r?s(e,t,i):s(i))||i);return r&&i&&Xs(e,t,i),i};let Ur=class extends q{handleInputChange(o){this.dispatchChange(o.detail.value)}renderEditor(){var o;return f`
      <vaadin-dev-tools-theme-text-input
        .value=${this.value}
        .showClearButton=${((o=this.propertyValue)==null?void 0:o.modified)||!1}
        @change=${this.handleInputChange}
      ></vaadin-dev-tools-theme-text-input>
    `}};Ur=Zs([F("vaadin-dev-tools-theme-text-property-editor")],Ur);var ea=Object.defineProperty,ta=Object.getOwnPropertyDescriptor,Uo=(o,e,t,r)=>{for(var i=r>1?void 0:r?ta(e,t):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(i=(r?s(e,t,i):s(i))||i);return r&&i&&ea(e,t,i),i};let At=class extends q{constructor(){super(...arguments),this.selectedPresetIndex=-1,this.presets=new Nt}static get styles(){return[q.styles,b`
        :host {
          --preset-count: 3;
          --slider-bg: #fff;
          --slider-border: #333;
...
`).replace(":host","html"),document.head.insertAdjacentElement("afterbegin",t)},pl=b`.grid-icon-vaadin{height:1em;width:1em}.grid-icon-vaadin{fill:var(--lumo-contrast-40pct)}.grid-icon-vaadin[active]{fill:var(--lumo-primary-color)}.grid-icon-vaadin[delete]{fill:var(--lumo-error-color)}.grid-icon-vaadin[expand]{fill:var(--lumo-contrast-40pct);height:1.8em}.grid-icon-lineawesome{height:1.8em;color:var(--lumo-secondary-text-color)}vaadin-grid::part(future-task){font-style:oblique}vaadin-grid::part(project-task){background-color:var(--lumo-complementary-color-5pct-opaque);color:var(--lumo-complementary-color)}vaadin-grid::part(completed-node){color:var(--lumo-tertiary-text-color);background-color:var(--lumo-shade-5pct-opaque)}vaadin-grid::part(primary-color){color:var(--lumo-primary-color)}vaadin-grid-cell-content{user-select:none;-webkit-touch-callout:none}vaadin-grid::part(exceeds-duration-limit){color:var(--lumo-tertiary-text-color)}vaadin-grid::part(difficult-task){font-weight:700}vaadin-grid::part(active-routine-step-task){text-shadow:0 0 2px white,0 0 20px var(--lumo-primary-color)}
`;document._vaadintheme_negentropy_componentCss||(nt("grid",zo(pl.toString())),document._vaadintheme_negentropy_componentCss=!0);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class ml extends HTMLElement{static get version(){return"24.1.5"}}customElements.define("vaadin-lumo-styles",ml);const me=(o,...e)=>{ul(`lumo-${o}`,e)};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const gl=b`
